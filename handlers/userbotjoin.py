...
async def addchannel(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<b>@vctgassistant5 already in your chat</b>",
        )
        pass
    except Exception as e:
        print(e)
        await message.reply_text(
            f"<b>🛑 Flood Wait Error 🛑 \n User {user.first_name} couldn't join your group due to heavy join requests for userbot! Make sure @vctgassistant5 is not banned in group."
...
async def rem(USER, message):
    try:
        ...
        await message.reply_text(
            f"<b>@vctgassistant5 couldn't leave your group! May be floodwaits."
