...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name =  "vctgassistant9"
    usar = user
    wew = usar.id
    try:
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@vctgassistant9 userbot joined your chat</b>",
                              )
                              ...
                              #print(e)
                              await lel.edit(
                                  f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure @vctgassistant9 is not banned in group."
                                  "\n\nOr manually add @vctgassistant9 to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
        ...
        await lel.edit(
            f"<i> {user.first_name} @vctgassistant9  not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually</i>"
        )
        return     
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@vctgassistant9 joined your chat</b>",
                              )
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> @vctgassistant9 Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
