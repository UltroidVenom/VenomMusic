...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name =  "GroupMusicUserbot"
    usar = user
    wew = usar.id
    try:
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              #print(e)
                              await lel.edit(
                                  f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure @GroupMusicUserbot is not banned in group."
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} @GroupMusicUserbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually</i>"
        )
        return     
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@GroupMusicUserbot joined your chat</b>",
                              )
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> @GroupMusicUserbot Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
